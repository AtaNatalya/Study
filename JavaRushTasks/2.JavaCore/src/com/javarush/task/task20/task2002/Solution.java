...
public class Solution {
    public static void main(String[] args) {
        ...
        try {
            File your_file_name = File.createTempFile("D:\\Study\\Java\\JavaRushTasks\\JavaRushTasks\\2.JavaCore\\src\\com\\javarush\\task\\task20\\task2002\\test.txt", null);
        ...
        public void load(InputStream inputStream) throws Exception {
            ...
            String name;
                while ((name = r.readLine()) != null){
                    ...
                    formatter.setTime(Long.parseLong(s));
                    user.setBirthDate(formatter);
                    user.setMale(Boolean.valueOf(r.readLine()));
